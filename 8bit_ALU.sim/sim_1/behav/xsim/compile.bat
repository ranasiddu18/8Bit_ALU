...
REM
REM Generated by Vivado on Mon Feb 09 03:34:19 +0530 2026
...
echo "xvlog --incr --relax -prj ALU8bit_tb_vlog.prj"
call xvlog  --incr --relax -prj ALU8bit_tb_vlog.prj -log xvlog.log
